...
//public class InterfaceWithDefaultImplementations {
//
//	
//
//}
...
class InterfaceWithDefaultImplementations extends Greet implements Greeting, GreetingExtn{
   public static void main(String[] args) {
	    new InterfaceWithDefaultImplementations().hello();
   }
}